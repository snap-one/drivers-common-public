...
--[[
	...
	auth.notifyHandler.PINCodeReceived = function (contextInfo, verification_url, user_code) end
	auth.notifyHandler.PINCodeWaiting = function (contextInfo) end
	auth.notifyHandler.PINCodeDenied = function (contextInfo, err, err_description, err_uri) end
	auth.notifyHandler.PINCodeExpired = function (contextInfo) end
	auth.notifyHandler.AccessTokenGranted = function (contextInfo, accessToken) end
	...
	-----------------
		...
		auth:GetPINCode (contextInfo, extras)
